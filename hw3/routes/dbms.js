...
var host = "35.247.21.67";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "root";         //username (change to match your db)
var password = "software_eng123";  //password (change to match your db, yes this is very poor practice)
